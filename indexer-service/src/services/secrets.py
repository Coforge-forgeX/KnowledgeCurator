"""
Secrets management service for indexer-service.
...
def get_secrets_adapter(force_recreate: bool = False) -> SecretsAdapter:
    """
    Get secrets adapter configured from indexer-service settings.
    ...
    Example:
        ...
        blob_connection = await secrets.get_secret("AZURE_BLOB_STORAGE_CONNECTION_STRING")
    """
