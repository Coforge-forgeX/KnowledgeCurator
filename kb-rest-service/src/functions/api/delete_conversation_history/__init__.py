...
POST /api/v2/chat/session/delete
Body: { "workspace_id": int, "user_id": int, "session_id": str }
"""
...
async def main(req: AbstractRequest, context: AbstractContext) -> AbstractResponse:
    ...
    try:
        ...
        logger.error("chat_delete_conversation failed", error=e)
        return create_error_response(
            message=str(e),
            error_code="CHAT_DELETE_FAILED",
            status_code=500,
            correlation_id=correlation_id,
        )
