...
# One event loop per warm container, reused across invocations.
#
...
# persistent loop a warm container skips the ~8s-per-KB LightRAG initialization
...
def lambda_handler(event: Dict[str, Any], context: Any) -> Dict[str, Any]:
    return _get_loop().run_until_complete(_handle(event, context))
